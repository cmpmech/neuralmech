...
save_csv(f'../../results/ml_tasks_reg.csv', x=x, y=y)
...
save_csv(f'../../results/ml_tasks_clas.csv', x1=x1, y1=y1, x2=x2, y2=y2)
...
save_csv(f'../../results/ml_tasks_rep.csv', x1=x1, y1=y1, x2=x2, y2=y2)
...
save_csv(f'../../results/ml_tasks_gen1.csv', x=x1, y=y1)
save_csv(f'../../results/ml_tasks_gen2.csv', x=x2, y=y2)