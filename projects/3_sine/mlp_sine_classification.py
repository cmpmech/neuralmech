...
# -------------------------------- book postprocessing --------------------------------
    ...
    save_csv(
        CSV_DIR / "mlp_discrete_sine_test.csv",
        x=x_test[:, 0],
        y=y_test,
        ypred=y_pred_test,
    )
    save_csv(CSV_DIR / "mlp_discrete_sine_train.csv", x=X_train[:, 0], y=Y_train)
    save_csv(CSV_DIR / "mlp_discrete_sine_val.csv", x=X_val[:, 0], y=Y_val)
