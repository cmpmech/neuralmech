...
static int _cffi_const_material_address(unsigned long long *o)
{
  int n = (material_address) <= 0;
  *o = (unsigned long long)((material_address) | 0);  /* check that material_address is an integer */
  return n;
}

static int _cffi_const_phasefield_address(unsigned long long *o)
{
  int n = (phasefield_address) <= 0;
  *o = (unsigned long long)((phasefield_address) | 0);  /* check that phasefield_address is an integer */
  return n;
}

static int _cffi_const_update_address(unsigned long long *o)
{
  int n = (update_address) <= 0;
  *o = (unsigned long long)((update_address) | 0);  /* check that update_address is an integer */
  return n;
}

static const struct _cffi_global_s _cffi_globals[] = {
  { "material_address", (void *)_cffi_const_material_address, _CFFI_OP(_CFFI_OP_CONSTANT_INT, -1), (void *)0 },
  { "phasefield_address", (void *)_cffi_const_phasefield_address, _CFFI_OP(_CFFI_OP_CONSTANT_INT, -1), (void *)0 },
  { "update_address", (void *)_cffi_const_update_address, _CFFI_OP(_CFFI_OP_CONSTANT_INT, -1), (void *)0 },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__sheartest_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__sheartest_cffi(void) { return NULL; }
#  else
     init_sheartest_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__sheartest_cffi(void)
{
  return _cffi_init("_sheartest_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_sheartest_cffi(void)
{
  _cffi_init("_sheartest_cffi", 0x2601, &_cffi_type_context);
}
#endif
