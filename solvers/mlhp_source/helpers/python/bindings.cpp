...
//
// Python bindings for the custom helper integrands. Compiled into the combined
// pymlhpcore module (mlhp._core) together with mlhp's own bindings, so the wrapper
// types (ScalarFunctionWrapper, DomainIntegrand) are shared and the helpers appear
// directly under `import mlhp`.

#include "pybind11/pybind11.h"
#include "pybind11/stl.h"
#include "pybind11/numpy.h"

#include "mlhp/python/pymlhpcore.hpp"
